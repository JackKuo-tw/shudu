...
$(function () {
    $('#convert button[type="submit"]').click(function (e) {
        ...
        const inputText = getContent();
        const configValue = $('#translation').val();
        const isRefinePunc = $('#punctuation').val() === "fullWidth";
